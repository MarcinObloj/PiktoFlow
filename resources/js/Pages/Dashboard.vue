...
// --- SYSTEM WŁASNEGO MODALA USUWANIA ---
const showDeleteModal = ref(false);
const deleteType = ref(''); // 'category' lub 'pictogram'
        ...
        <div class="py-8 sm:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 bg-gradient-to-br from-white to-blue-50 overflow-hidden shadow-sm sm:rounded-3xl border border-blue-100 p-6 sm:p-10 flex flex-col md:flex-row justify-between items-center gap-6 relative rounded-2xl">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow rounded-2xl sm:rounded-3xl border border-gray-100 p-6 sm:p-8 flex flex-col justify-between group">
                        <div>
                            ...
                            <p class="text-gray-500 mb-8 leading-relaxed">Stwórz nową grupę słów, aby lepiej zorganizować tablicę swojego dziecka (np. "Moje zabawki").</p>
                        </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow rounded-2xl sm:rounded-3xl border border-gray-100 p-6 sm:p-8 flex flex-col justify-between group">
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 mb-3">Piktogramy</h4>
                            <p class="text-gray-500 mb-8 leading-relaxed">Wgraj zdjęcie z komputera lub telefonu, jeśli brakuje Ci jakiegoś słowa w bazie ARASAAC.</p>
                        </div>
                ...
                <div class="bg-gray-50 rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-gray-200">
                    ...
                    <div class="mb-12">
                        ...
                        <div v-if="myCategories.length === 0" class="text-gray-500 font-medium italic bg-white p-6 rounded-2xl border border-gray-100 text-center shadow-sm">
                            Brak własnych kategorii. Dodaj pierwszą, klikając "+ Nowa kategoria" powyżej.
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            <div v-for="cat in myCategories" :key="cat.id" class="bg-white border-l-8 rounded-2xl p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow group" :style="{ borderLeftColor: cat.color }">
                                ...
                                <button @click="openDeleteModal('category', cat.id)" class="text-gray-400 hover:text-red-600 hover:bg-red-50 w-10 h-10 rounded-xl flex items-center justify-center transition-colors shrink-0" title="Usuń kategorię">
                    ...
                    <div>
                        ...
                        <div v-if="myPictograms.length === 0" class="text-gray-500 font-medium italic bg-white p-6 rounded-2xl border border-gray-100 text-center shadow-sm">
                            Brak wgranych obrazków. Dodaj swoje pierwsze zdjęcie.
                        </div>
            ...
            <div class="bg-white rounded-[2rem] p-8 sm:p-10 max-w-md w-full shadow-2xl text-center transform transition-all border-4 border-red-50 relative overflow-hidden">
                ...
                <p class="text-gray-600 mb-8 font-medium leading-relaxed">
                    <span v-if="deleteType === 'category'">
                        ...
                        <strong class="text-red-500">UWAGA:</strong> Wszystkie piktogramy znajdujące się w tej kategorii również zostaną trwale usunięte. Tej akcji nie można cofnąć!
                    </span>
                    <span v-else>
                        Czy na pewno chcesz trwale usunąć ten piktogram z Twojej biblioteki? Tej akcji nie można cofnąć.
                    </span>
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-3 mt-6">
                    ...
                    <button @click="confirmDeletion" class="flex-1 px-4 py-4 bg-red-500 text-white font-bold rounded-2xl hover:bg-red-600 transition shadow-lg shadow-red-200 active:scale-95">
                        Tak, usuń trwale
                    </button>
                </div>
            </div>

    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link :href="route('children.create')" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow transition">
                    + Dodaj profil
                </Link>
            </div>
        </template>
                ...
                <form @submit.prevent="submitUpdate" class="flex flex-col gap-6 overflow-y-auto pr-2">
                    ...
                    <div class="flex flex-wrap justify-between items-center mt-4 pt-6 border-t border-gray-100 shrink-0 gap-4">
                        ...
                        <div class="flex gap-3">
                            <button type="button" @click="closeSettingsModal" class="px-4 py-2 bg-gray-200 font-bold rounded-md text-gray-800 hover:bg-gray-300">
                                Anuluj
                            </button>
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-[110] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
            <div class="bg-white rounded-[2rem] p-8 sm:p-10 max-w-md w-full shadow-2xl text-center transform transition-all border-4 border-red-100 relative overflow-hidden flex flex-col items-center">
                ...
                <div class="grid grid-cols-2 gap-4 w-full mt-2">
                    <button @click="closeDeleteModal" class="py-4 bg-gray-200 text-gray-800 font-bold rounded-xl hover:bg-gray-300 transition">
                        Anuluj
                    </button>
                    <button @click="confirmDelete" class="py-4 bg-red-600 text-white font-bold rounded-xl hover:bg-red-700 transition shadow-md">
                        Usuń
                    </button>
                </div>
            </div>

...
<template>
    <section>
        <header>
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Bezpieczeństwo</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Upewnij się, że Twoje konto używa długiego, losowego hasła.</p>
        </header>

        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <label class="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Obecne hasło</label>
                <input
            ...
            <div>
                <label class="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Nowe hasło</label>
                <input
                    ref="passwordInput"
            ...
            <div>
                <label class="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Potwierdź nowe hasło</label>
                <input
